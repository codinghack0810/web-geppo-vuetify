  ...
  <v-expansion-panel>
    ...
    <v-expansion-panel-text>
      <div>
        ...
        <span class="ml-3 pa-3" :style="{ color: 'rgb(var(--v-theme-main))' }" v-if="item !== nowMonth">2024/05/07</span>
        <span class="ml-3 pa-2" :style="{ color: 'rgb(var(--v-theme-main))' }" v-else>
          <input type="date" class="pa-2 mr-3 rounded-lg" :style="{ border: '1px solid rgb(var(--v-theme-inputBorder))' }" name="" id="" />
      ...
      <div class="d-flex align-end justify-space-between" style="gap: 20px">
        <div class="d-flex align-end pr-15">
          ...
          <div :style="{ fontSize: '150px' }" v-if="item !== nowMonth">{{ item }}</div>
          <div :style="{ fontSize: '150px' }" v-else>{{ item }}</div>
        </div>
        <div class="w-100">
        ...
        <div class="w-100">
          <div class="d-flex flex-column gap-3 pb-5">
            <div class="text-center" :style="{ fontSize: '50px' }">143<span class="text-subtitle-1">人</span></div>
